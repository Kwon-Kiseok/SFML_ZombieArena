...
private:
	...
	static std::list<Mouse::Button> OnButtonUp;
	static std::list<Mouse::Button> OnButtonDown;
...
public:
	...
	static bool GetLeftButton(Mouse::Button button);
	static bool GetLeftButtonUp(Mouse::Button button);
};
